...
cd /tmp/downloads && \
curl -sSLO https://github.com/prometheus/node_exporter/releases/download/v0.17.0/node_exporter-0.17.0.linux-armv7.tar.gz && \
tar xfvz node_exporter-0.17.0.linux-armv7.tar.gz && \
...
cp /tmp/downloads/node_exporter-0.17.0.linux-armv7/node_exporter /usr/sbin/node_exporter && \
